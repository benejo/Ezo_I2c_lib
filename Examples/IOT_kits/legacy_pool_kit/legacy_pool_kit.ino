...
const String ssid = "";                                 //The name of the Wi-Fi network you are connecting to
const String pass = "";                             //Your WiFi network password
const long myChannelNumber = 1327054;                            //Your Thingspeak channel number
const char * myWriteAPIKey = "CUI1L0BCI064JHV1";                 //Your ThingSpeak Write API Key
//------------------------------------------------------------------


Ezo_board PH = Ezo_board(99, "PH");           //create a PH circuit object, who's address is 99 and name is "PH"
Ezo_board EC = Ezo_board(100, "EC");         //create an EC circuit object who's address is 98 and name is "EC"
...
const unsigned long thingspeak_delay = 600000;             //how long we wait to send values to thingspeak, in milliseconds
...
void print_help() {
  ...
  Serial.println(F("                                                                           "));
  Serial.println(F("EC:cal,225          calibrate EC probe to 225mV                          "));
